...
export const FEED_ITEMS: FeedItem[] = [
  ...
  },
  {
    ...
    author: CELESTINA_LEON,
    headline: "The Emerald Dispensary (not the same as the Broadway location) has operated on 85 Suydam for two years. Should their temporary license become permanent?",
    snippet:
  ...
  },
  {
    id: "cathedral-of-joy",
    author: CELESTINA_LEON,
    headline: "The Cathedral of Joy at Evergreen and George Knoll may be sold. What should happen to the space?",
    snippet:
